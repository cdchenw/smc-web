...
export const COMPANIES: Company[] = [
  {
    ...
    turnover: 560234556,
    ceo: 'Mark Hurd',
    boardOfDirector: 'Lawrence J. Ellison > Chairman of the Board and Chief Technology Officer',
    sector: [{
      id: '1',
      name: 'Finance',
      brief: 'oracle data base is the top one db in industry.'
    },
    {
      id: '2',
    ...
    briefWriteUp: 'Oracle’s rapid transformation from a product company into a leading cloud services provider was powered by the complete suite of Oracle Cloud services. Oracle Cloud has helped us realize unprecedented cost savings, accelerated growth, and increased customer and employee satisfaction.',
    stockExchagneList: [{
      stockExchange: {
